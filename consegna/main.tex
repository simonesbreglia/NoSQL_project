...
insieme alle informaioni sulle vendite, sui clienti e sugli impiegati del negozio musicale. In Figura~\ref{fig:chinook_schema} è 
riportato lo schema del database originale, composto da 11 tabelle. Il database è stato convertito in un formato NoSQL,
