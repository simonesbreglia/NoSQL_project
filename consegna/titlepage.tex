...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \centering
    {\Huge \textbf{\textcolor{black}{Esplorazione del database Chinook tramite un'interfaccia grafica e MongoDB}}}\footnote{Repository codice: \url{https://github.com/simonesbreglia/NoSQL\_project}}\\[1.5cm]
    \textsc{\LARGE Course Name}\\[0.5cm]
    \text{\large Big Data Analytics}\\[2cm]
    
    {\Large \textbf{\textcolor{unimorered}{Author:      }}}\\[0.5cm]
    \begin{tabular}{c}
        \Large \textcolor{unimoregrey}{Simone Sbreglia} \\
